      ...
      <div className={`sidebar ${isOpen ? 'open' : ''}`}>
        ...
        {user?.cargo === 'superadmin' && (
          <div style={{ padding: '0 20px', marginBottom: '15px' }}>
            <label style={{ fontSize: '0.75rem', color: '#8B5CF6', fontWeight: 'bold', display: 'block', marginBottom: '5px' }}>
        ...
        <nav className="nav-scrollable">
          ...
          {modulos.includes('estoque') && can('estoque.ver') && (
            <Link to="/estoque" className={isActive('/estoque')}><Package size={20} /> Estoque</Link>
          )}
      ...
      <div className="content">
        <div className="content">
          <Routes>
            ...
            <Route path="/estoque" element={<PrivateRoute permissions={['estoque.ver']}><Estoque /></PrivateRoute>} />
