...
export default function Rastreamento() {
    const [abaAtiva, setAbaAtiva] = usePersistedTab('geral', 'rastreamento');
            ...
            <div className="filter-bar" style={{ borderBottom: '1px solid #2d3748', margin: 0, borderRadius: 0 }}>
                ...
                <div style={{ alignSelf: 'flex-end' }}>
                    <button
                        ...
                        className="btn-add"
                        style={{ height: '38px', backgroundColor: '#8B5CF6', color: '#fff', display: 'flex', alignItems: 'center', padding: '0 20px' }}
                        disabled={loading}
                    >
                    ...
                    <div className={`track-sidebar ${resumoAberto ? 'open' : ''}`}>
                        ...
                        <div style={{ marginTop: '20px' }}>
                            ...
                            <ul style={{ listStyle: 'none', padding: 0, color: '#e2e8f0', fontSize: '0.9rem' }}>
                                <li style={{ marginBottom: '10px', paddingLeft: '10px', borderLeft: '2px solid #8B5CF6' }}>
