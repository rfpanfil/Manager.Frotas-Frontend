...
export default function EstoqueHeaderFiltros({
    ...
    return (
        <div className="filter-bar" style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 20, flexWrap: 'wrap', gap: '15px' }}>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 15, flex: 1, minWidth: '300px' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, alignItems: 'center' }}>
                {can('estoque.baixar') && ( <button onClick={onExportarPDF} className="btn-add" style={{ background: '#e53e3e', border: 'none', color: 'white', padding: '0 15px' }} title="Baixar Relatório">
