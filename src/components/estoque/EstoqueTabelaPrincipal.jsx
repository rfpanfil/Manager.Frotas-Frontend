// Arquivo: frontend/src/components/estoque/EstoqueTabelaPrincipal.jsx
                                ...
                                <td>
                                    <div style={{ display: 'flex', gap: 10, justifyContent: 'center' }}>
                                        {can('estoque.movimentar') && (
                                            <>
                                                <button onClick={() => onEntrada(item.id)} title="Dar Entrada" style={{ background: 'none', border: 'none', color: '#00d68f', cursor: 'pointer' }}><ArrowUpCircle size={16} /></button>
