        ...
        <div className="filter-bar">
            ...
            <div className="filter-item" style={{ position: 'relative' }}>
                ...
                <button onClick={() => setMenuPeriodoAberto(!menuPeriodoAberto)} style={{
                    ...
                    color: 'white',
                    border: usarFiltroPeriodo ? '1px solid #8B5CF6' : '1px solid #444',
                    padding: '8px', borderRadius: '4px', cursor: 'pointer', display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '15px', minWidth: '180px', justifyContent: 'space-between'
                }}>
