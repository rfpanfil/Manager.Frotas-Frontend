                                ...
                                <tr key={sc.id}>
                                    ...
                                    <td>
                                        <div style={{ display: 'flex', gap: 10 }}>
                                            ...
                                            <button onClick={() => baixarComparativoPDF(sc)} title="Baixar PDF" className="btn-add" style={{ background: 'transparent', border: '1px solid #a0aec0', color: '#a0aec0', padding: '5px 10px', fontSize: '0.8rem' }}>
