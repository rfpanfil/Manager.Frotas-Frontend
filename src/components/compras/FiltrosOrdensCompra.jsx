            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 15, alignItems: 'center', marginBottom: 15 }}>
                ...
                <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
                    ...
                    {can('compras.oc.criar') && (
                        <button onClick={abrirModalOCManual} className="btn-add" style={{ flex: 1, background: '#00d68f', color: 'black', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5 }}>
