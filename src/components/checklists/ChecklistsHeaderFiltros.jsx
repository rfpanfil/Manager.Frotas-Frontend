...
export default function ChecklistsHeaderFiltros({
    ...
    return (
        <>
            <div className="filter-bar" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '15px', marginBottom: 20 }}>
                <div style={{ display: 'flex', gap: 10, alignItems: 'center', flexWrap: 'wrap' }}>
                    ...
                    {podeBaixar && (
                        <div style={{ display: 'flex', gap: 5, alignSelf: 'flex-end' }}>
                            ...
                            {can('checklists.baixar') && ( <button onClick={handleExportarDetalhado} className="btn-add" style={{ background: '#e53e3e', color: 'white', height: '38px' }}>
