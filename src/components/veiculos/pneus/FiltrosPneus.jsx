...
export default function FiltrosPneus({
    ...
    return (
        <div className="filter-bar" style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 20, flexWrap: 'wrap', gap: 15 }}>
            ...
            {can('pneus.movimentar') && (
                <button onClick={() => { setVeiculoMontagem(null); setModalMontagem(true); }} className="btn-add" style={{ background: '#8B5CF6', color: '#fff', fontWeight: 'bold' }}>
