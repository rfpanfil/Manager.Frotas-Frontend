...
export default function CardsDashboardPneus({ resumo, setModalListaStatus, setBuscaModalStatus }) {
    return (
        <div style={{ display: 'flex', gap: 15, marginBottom: 25 }}>
            <CardDashboard titulo="Em Uso (Montados)" valor={resumo.em_uso} cor="#8B5CF6" statusFiltro="EM_USO" setModalListaStatus={setModalListaStatus} setBuscaModalStatus={setBuscaModalStatus} />
