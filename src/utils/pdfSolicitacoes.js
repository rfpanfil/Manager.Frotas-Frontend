...
export const baixarResumoPDF = async (sc, bases, getNomeItem) => {
    ...
    doc.text(`Solicitante (Usuário Logado): ${sc.solicitante?.nome || 'Sistema'}`, 14, 70);
    doc.text(`Colaborador Vinculado: ${sc.colaborador?.nome ? sc.colaborador.nome : 'Nenhum'}`, 110, 70);
